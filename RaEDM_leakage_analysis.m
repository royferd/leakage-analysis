...
hv_plot_xy_errors('',...
    ...
    ramp_down_stdev_median_discharge_size_sum,zeros(1,length(ramp_down_stdev_dph_sum)));
...
time_ramp_down(1:down_chunk_array(:,2,num_down_chunks)),...
zeros(1,length(time_ramp_down(1:down_chunk_array(:,2,num_down_chunks)))),...
vmon_avg_ramp_down_raw(1:down_chunk_array(:,2,num_down_chunks))*vmon_avg_scale,...
vmon_avg_ramp_down_stdev_raw(1:down_chunk_array(:,2,num_down_chunks))*vmon_avg_scale,...
time_ramp_up(1:up_chunk_array(:,2,num_up_chunks)),...
zeros(1,length(time_ramp_up(1:up_chunk_array(:,2,num_up_chunks)))),...
vmon_avg_ramp_up_raw(1:up_chunk_array(:,2,num_up_chunks))*vmon_avg_scale,...
vmon_avg_ramp_up_stdev_raw(1:up_chunk_array(:,2,num_up_chunks))*vmon_avg_scale,...
time_trash(1:trash_chunk_array(:,2,num_trash_chunks)),...
zeros(1,length(time_trash(1:trash_chunk_array(:,2,num_trash_chunks)))),...
vmon_avg_trash_raw(1:trash_chunk_array(:,2,num_trash_chunks))*vmon_avg_scale,...
vmon_avg_trash_stdev_raw(1:trash_chunk_array(:,2,num_trash_chunks))*vmon_avg_scale);
