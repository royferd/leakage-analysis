...
datafile = '2019-04-11-171358-hv-1.txt';
power_supply = 4;
...
hv_plot_xy_errors('EDMRS voltage data with zero data','',...
    1,0,fullpath,'voltage-chunks-color-coded-zero',...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev,...
...
hv_plot_xy_errors('EDMRS trash voltage plotted over all','',...
    1,0,fullpath,'trash-chunks-plotted-over-all-voltage',...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev,...
