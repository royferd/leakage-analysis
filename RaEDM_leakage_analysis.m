...
datafile = '2019-11-26-171435-hv-1.txt'; power_supply = 4;
...
% all avg discharges
hv_plot_xy_errors('All avg. discharges','time (min)','discharge values (pA)',1,...
...
% +/- V avg discharges
hv_plot_xy_errors('+V/-V avg. discharges','time (min)','discharge value (pA)',1,...
    sprintf('%d discharges at %.1f kV \n %d discharges at %.1f kV \n %d discharges at %.1f kV',...
    sum(ramp_up_avg_count_discharges(1,:)),vmon_avg_ramp_up_avg,...
    sum(ramp_down_avg_count_discharges(1,:)),vmon_avg_ramp_down_avg,...
    sum(zero_avg_count_discharges(1,:)),vmon_avg_zero_avg),...
...
hv_plot_xy_errors('All stdev discharges','time (min)','discharge value (pA)',1,...
    sprintf('%d discharges at %.1f kV \n %d discharges at %.1f kV \n %d discharges at %.1f kV',...
...
% +/- V stdev discharges
hv_plot_xy_errors('+V/-V stdev discharges','time (min)','discharge value (pA)',1,...
    sprintf('%d discharges at %.1f kV \n %d discharges at %.1f kV \n %d discharges at %.1f kV',...
    sum(ramp_up_stdev_count_discharges(1,:)),vmon_avg_ramp_up_avg,...
    sum(ramp_down_stdev_count_discharges(1,:)),vmon_avg_ramp_down_avg,...
    sum(zero_stdev_count_discharges(1,:)),vmon_avg_zero_avg),...
...
hv_plot_xy_errors('+V/-V stdev discharge rates','time (# hours)','average discharges per hour',1,'',...
...
hv_plot_xy_errors('+V/-V stdev discharge sizes by chunk',...
    'time (# hours)','median discharge size (pA)',1,'',...
    1,1,fullpath,'pos-neg-stdev-median',[],...
    1:length(ramp_up_stdev_dph),zeros(1,length(ramp_up_stdev_dph)),...
...
hv_plot_xy_errors('+V/-V stdev discharges with summed chunk',...
    'time (# hours)','median discharge size (pA)',1,'',...
    1,1,fullpath,'pos-neg-stdev-median-sum',[],...
