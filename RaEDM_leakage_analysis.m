...
[ramp_up_avg_discharge_times_sum,ramp_up_avg_discharge_times_sum_cutoff,...
    ...
    ramp_up_avg_time_length_of_chunk_cutoff] = ...
    find_discharges_final(lcm1_avg_ramp_up_raw,...
...
[ramp_down_avg_discharge_times,ramp_down_avg_discharge_times_cutoff,...
    ...
    ramp_down_avg_time_length_of_chunk_cutoff] = ...
...
[ramp_down_avg_discharge_times_sum,ramp_down_avg_discharge_times_sum_cutoff,...
    ...
    ramp_down_avg_time_length_of_chunk_sum_cutoff] = ...
    find_discharges_final(lcm1_avg_ramp_down_raw,...
...
[zero_avg_discharge_times,zero_avg_discharge_times_cutoff,...
    ...
    zero_avg_time_length_of_chunk_cutoff] = ...
...
[zero_avg_discharge_times_sum,zero_avg_discharge_times_sum_cutoff,...
    ...
    zero_avg_time_length_of_chunk_sum_cutoff] = ...
    find_discharges_final(lcm1_avg_zero_raw,...
...
[zero_stdev_discharge_times,zero_stdev_discharge_times_cutoff, zero_stdev_discharge_vals, ...
    ...
    zero_stdev_time_length_of_chunk] = ...
...
[zero_stdev_discharge_times_sum,zero_stdev_discharge_times_sum_cutoff,...
    ...
    zero_stdev_time_length_of_chunk_sum] = ...
    find_discharges_final(lcm1_stdev_zero_raw,...
...
[ramp_down_stdev_discharge_times,ramp_down_stdev_discharge_times_cutoff, ramp_down_stdev_discharge_vals, ...
    ...
    ramp_down_stdev_time_length_of_chunk] = ...
...
[ramp_down_stdev_discharge_times_sum,ramp_down_stdev_discharge_times_sum_cutoff,...
    ...
    ramp_down_stdev_time_length_of_chunk_sum] = ...
    find_discharges_final(lcm1_avg_ramp_down_stdev_raw,...
...
[ramp_up_stdev_discharge_times,ramp_up_stdev_discharge_times_cutoff, ramp_up_stdev_discharge_vals, ...
    ...
    ramp_up_stdev_time_length_of_chunk] = ...
...
[ramp_up_stdev_discharge_times_sum,ramp_up_stdev_discharge_times_sum_cutoff,...
    ...
    ramp_up_stdev_time_length_of_chunk_sum] = ...
    find_discharges_final(lcm1_avg_ramp_up_stdev_raw,...
...
for k = 1:10
    ...
    hv_plot_xy_errors('ramp simulation zero voltage plotted over all','',...
        1,0,fullpath,sprintf('zero-voltage-chunk-%d',k),...
        time,...
        zeros(1,length(time)),...
        vmon_avg,...
        vmon_avg_stdev,...
...
hv_plot_xy_errors('ramp simulation zero voltage plotted over all','',...
    1,0,fullpath,sprintf('zero-voltage-chunk-%d',68),...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev,...
    zero_time(zero_chunk_array(1,1,68)+1:zero_chunk_array(:,2,68)),...
    zeros(1,length(zero_time(zero_chunk_array(1,1,68)+1:zero_chunk_array(1,2,68)))),...
    vmon_avg_zero_raw(zero_chunk_array(1,1,68)+1:zero_chunk_array(1,2,68))*vmon_avg_scale,...
    vmon_stdev_zero_raw(zero_chunk_array(1,1,68)+1:zero_chunk_array(1,2,68))*abs(vmon_avg_scale));

for k = 1:10
    
    hv_plot_xy_errors('ramp simulation trash voltage plotted over all','',...
        1,0,fullpath,sprintf('trash-voltage-chunk-%d',k),...
        time,...
        zeros(1,length(time)),...
        vmon_avg,...
        vmon_avg_stdev,...
...
hv_plot_xy_errors('ramp simulation trash voltage plotted over all','',...
    1,0,fullpath,sprintf('trash-voltage-chunk-%d',68),...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev,...
    time_trash(trash_chunk_array(1,1,68)+1:trash_chunk_array(:,2,68)),...
    zeros(1,length(time_trash(trash_chunk_array(1,1,68)+1:trash_chunk_array(1,2,68)))),...
    vmon_avg_trash_raw(trash_chunk_array(1,1,68)+1:trash_chunk_array(1,2,68))*vmon_avg_scale,...
    vmon_avg_trash_stdev_raw(trash_chunk_array(1,1,68)+1:trash_chunk_array(1,2,68))*abs(vmon_avg_scale),...
    zero_time(zero_chunk_array(1,1,68)+1:zero_chunk_array(:,2,68)),...
    zeros(1,length(zero_time(zero_chunk_array(1,1,68)+1:zero_chunk_array(1,2,68)))),...
    vmon_avg_zero_raw(zero_chunk_array(1,1,68)+1:zero_chunk_array(1,2,68))*vmon_avg_scale,...
    vmon_stdev_zero_raw(zero_chunk_array(1,1,68)+1:zero_chunk_array(1,2,68))*abs(vmon_avg_scale));
...
for k = 1:10
    ...
    hv_plot_xy_errors('ramp simulation discharge voltage plotted over all','',...
        1,0,fullpath,sprintf('discharge-voltage-chunk-%d',k),...
        time,...
        zeros(1,length(time)),...
        vmon_avg,...
        vmon_avg_stdev,...
...
for k = 1:10
    ...
    hv_plot_xy_errors('ramp simulation charge voltage plotted over all','',...
        1,0,fullpath,sprintf('charge-voltage-chunk-%d',k),...
        time,...
        zeros(1,length(time)),...
        vmon_avg,...
        vmon_avg_stdev,...
...
hv_plot_xy_errors('ramp simulation (dis)charging voltage plotted over all','',...
    1,0,fullpath,sprintf('charge-voltage-chunk-%d',68),...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev,...
    time_trash(charge_index(1,68,2):charge_index(1,68,3)),...
    zeros(1,length(time_trash(charge_index(1,68,2):charge_index(1,68,3)))),...
    vmon_avg_trash_raw(charge_index(1,68,2):charge_index(1,68,3))*vmon_avg_scale,...
    vmon_avg_trash_stdev_raw(charge_index(1,68,2):charge_index(1,68,3))*abs(vmon_avg_scale),...
    time_trash(discharge_index(1,68,2):discharge_index(1,68,3)),...
    zeros(1,length(time_trash(discharge_index(1,68,2):discharge_index(1,68,3)))),...
    vmon_avg_trash_raw(discharge_index(1,68,2):discharge_index(1,68,3))*vmon_avg_scale,...
    vmon_avg_trash_stdev_raw(discharge_index(1,68,2):discharge_index(1,68,3))*abs(vmon_avg_scale));

hv_plot_xy_errors('ramp simulation (dis)charging voltage points plotted over all','',...
    1,0,fullpath,sprintf('charge-voltage-point-chunk-%d',68),...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev,...
    time_trash(charge_index(1,68,2)),...
    zeros(1,length(time_trash(charge_index(1,68,2)))),...
    vmon_avg_trash_raw(charge_index(1,68,2))*vmon_avg_scale,...
    vmon_avg_trash_stdev_raw(charge_index(1,68,2))*abs(vmon_avg_scale),...
    time_trash(discharge_index(1,68,3)),...
    zeros(1,length(time_trash(discharge_index(1,68,3)))),...
    vmon_avg_trash_raw(discharge_index(1,68,3))*vmon_avg_scale,...
    vmon_avg_trash_stdev_raw(discharge_index(1,68,3))*abs(vmon_avg_scale));
