...
% datafile = '2018-10-25-153857-hv-1.txt';
...
hv_plot_xy_errors('EDMRS voltage data with trash','',...
    ...
    vmon_avg,...
    vmon_avg_stdev,...
    time_ramp_down(down_chunk_array(:,1,4)+1:down_chunk_array(:,2,4)),...
    zeros(1,length(time_ramp_down(down_chunk_array(:,1,4)+1:down_chunk_array(:,2,4)))),...
    vmon_avg_ramp_down_raw(down_chunk_array(:,1,4)+1:down_chunk_array(:,2,4))*vmon_avg_scale,...
    vmon_avg_ramp_down_stdev_raw(down_chunk_array(:,1,4)+1:down_chunk_array(:,2,4))*vmon_avg_scale,...
    time_ramp_down(down_chunk_array(:,1,5)+1:down_chunk_array(:,2,5)),...
    zeros(1,length(time_ramp_down(down_chunk_array(:,1,5)+1:down_chunk_array(:,2,5)))),...
    vmon_avg_ramp_down_raw(down_chunk_array(:,1,5)+1:down_chunk_array(:,2,5))*vmon_avg_scale,...
    vmon_avg_ramp_down_stdev_raw(down_chunk_array(:,1,5)+1:down_chunk_array(:,2,5))*vmon_avg_scale,...
    time_ramp_down(down_chunk_array(:,1,6)+1:down_chunk_array(:,2,6)),...
    zeros(1,length(time_ramp_down(down_chunk_array(:,1,6)+1:down_chunk_array(:,2,6)))),...
    vmon_avg_ramp_down_raw(down_chunk_array(:,1,6)+1:down_chunk_array(:,2,6))*vmon_avg_scale,...
    vmon_avg_ramp_down_stdev_raw(down_chunk_array(:,1,6)+1:down_chunk_array(:,2,6))*vmon_avg_scale);
