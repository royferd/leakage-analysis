...
% datafile = '2017-10-23-175202-hv-1.txt';
...
hv_plot_xy_errors('+V/-V stdev discharge rates','',...
...
hv_plot_xy_errors('+V/-V stdev median discharges with separate chunks','',...
...
hv_plot_xy_errors('All stdev median discharges with summed chunks','',...
...
hv_plot_xy_errors('EDMRS voltage data with trash','',...
...
hv_plot_xy_errors('EDMRS leakage data with trash','',...
...
hv_plot_xy_errors('EDMRS voltage data','',...
...
hv_plot_xy_errors('EDMRS leakage data','',...
...
hv_plot_xy_errors('EDMRS zero leakage plotted over all','',...
...
hv_plot_xy_errors('EDMRS negative voltage plotted over all','',...
...
for k = 1:10
    ...
    hv_plot_xy_errors('EDMRS zero voltage plotted over all','',...
...
hv_plot_xy_errors('EDMRS zero voltage plotted over all','',...
    1,0,fullpath,sprintf('zero-voltage-chunk-%d',num_zero_chunks),...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev,...
...
for k = 1:3
    ...
    hv_plot_xy_errors('EDMRS trash voltage plotted over all','',...
...
hv_plot_xy_errors('EDMRS trash voltage plotted over all','',...
    1,0,fullpath,sprintf('trash-voltage-chunk-%d',num_trash_chunks),...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev,...
...
hv_plot_xy_errors('EDMRS ramping voltage voltage plotted over all','',...
    1,0,fullpath,sprintf('charge-voltage-chunk-%d',num_trash_chunks),...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev,...
...
hv_plot_xy_errors('EDMRS ramping voltage plotted over all','',...
    1,0,fullpath,sprintf('charge-voltage-point-chunk-%d',num_zero_chunks),...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev,...
...
hv_plot_xy_errors('EDMRS voltage data with trash','',...
    ...
    vmon_avg,...
    vmon_avg_stdev,...
    zero_time(zero_chunk_array(:,1,8)+1:zero_chunk_array(:,2,8)),...
    zeros(1,length(time_ramp_down(zero_chunk_array(:,1,8)+1:zero_chunk_array(:,2,8)))),...
    vmon_avg_zero_raw(zero_chunk_array(:,1,8)+1:zero_chunk_array(:,2,8))*vmon_avg_scale,...
    vmon_stdev_zero_raw(zero_chunk_array(:,1,8)+1:zero_chunk_array(:,2,8))*vmon_avg_scale,...
    zero_time(zero_chunk_array(:,1,9)+1:zero_chunk_array(:,2,9)),...
    zeros(1,length(time_ramp_down(zero_chunk_array(:,1,9)+1:zero_chunk_array(:,2,9)))),...
    vmon_avg_zero_raw(zero_chunk_array(:,1,9)+1:zero_chunk_array(:,2,9))*vmon_avg_scale,...
    vmon_stdev_zero_raw(zero_chunk_array(:,1,9)+1:zero_chunk_array(:,2,9))*vmon_avg_scale,...
    zero_time(zero_chunk_array(:,1,10)+1:zero_chunk_array(:,2,10)),...
    zeros(1,length(time_ramp_down(zero_chunk_array(:,1,10)+1:zero_chunk_array(:,2,10)))),...
    vmon_avg_zero_raw(zero_chunk_array(:,1,10)+1:zero_chunk_array(:,2,10))*vmon_avg_scale,...
    vmon_stdev_zero_raw(zero_chunk_array(:,1,10)+1:zero_chunk_array(:,2,10))*vmon_avg_scale);

hv_plot_xy_errors('EDMRS voltage data','',...
    1,0,fullpath,'voltage-chunks',...
    time,...
    zeros(1,length(time)),...
    vmon_avg,...
    vmon_avg_stdev);
...
hv_plot_xy_errors('EDMRS leakage data with trash','',...
    ...
    zero_time(zero_chunk_array(:,1,8)+1:zero_chunk_array(:,2,8)),...
    zeros(1,length(time_ramp_down(zero_chunk_array(:,1,8)+1:zero_chunk_array(:,2,8)))),...
    lcm1_avg_zero_raw(zero_chunk_array(:,1,8)+1:zero_chunk_array(:,2,8))*lcm1_avg_scale,...
    lcm1_stdev_zero_raw(zero_chunk_array(:,1,8)+1:zero_chunk_array(:,2,8))*lcm1_avg_scale,...
    zero_time(zero_chunk_array(:,1,9)+1:zero_chunk_array(:,2,9)),...
    zeros(1,length(time_ramp_down(zero_chunk_array(:,1,9)+1:zero_chunk_array(:,2,9)))),...
    lcm1_avg_zero_raw(zero_chunk_array(:,1,9)+1:zero_chunk_array(:,2,9))*lcm1_avg_scale,...
    lcm1_stdev_zero_raw(zero_chunk_array(:,1,9)+1:zero_chunk_array(:,2,9))*lcm1_avg_scale,...
    zero_time(zero_chunk_array(:,1,10)+1:zero_chunk_array(:,2,10)),...
    zeros(1,length(time_ramp_down(zero_chunk_array(:,1,10)+1:zero_chunk_array(:,2,10)))),...
    lcm1_avg_zero_raw(zero_chunk_array(:,1,10)+1:zero_chunk_array(:,2,10))*lcm1_avg_scale,...
    lcm1_stdev_zero_raw(zero_chunk_array(:,1,10)+1:zero_chunk_array(:,2,10))*lcm1_avg_scale);

hv_plot_xy_errors('EDMRS leakage data','',...
    1,0,fullpath,'leakage-chunks',...
    time,...
    zeros(1,length(time)),...
    lcm1_avg,...
    lcm1_avg_stdev);
