...
% all avg discharges
hv_plot_xy_errors('All avg. discharges','x axis','y axis',1,...
...
% +/- V avg discharges
hv_plot_xy_errors('+V/-V avg. discharges','x axis','y axis',1,...
    sprintf('%d discharges at %.1f kV \n %d discharges at %.1f kV \n %d discharges at %.1f kV',...
    sum(ramp_up_avg_count_discharges(1,:)),vmon_avg_ramp_up_avg,...
    sum(ramp_down_avg_count_discharges(1,:)),vmon_avg_ramp_down_avg,...
    sum(zero_avg_count_discharges(1,:)),vmon_avg_zero_avg),...
...
hv_plot_xy_errors('All stdev discharges','x axis','y axis',1,...
    sprintf('%d discharges at %.1f kV \n %d discharges at %.1f kV \n %d discharges at %.1f kV',...
...
% +/- V stdev discharges
hv_plot_xy_errors('+V/-V stdev discharges','x axis','y axis',1,...
    sprintf('%d discharges at %.1f kV \n %d discharges at %.1f kV \n %d discharges at %.1f kV',...
    sum(ramp_up_stdev_count_discharges(1,:)),vmon_avg_ramp_up_avg,...
    sum(ramp_down_stdev_count_discharges(1,:)),vmon_avg_ramp_down_avg,...
    sum(zero_stdev_count_discharges(1,:)),vmon_avg_zero_avg),...
...
hv_plot_xy_errors('+V/-V stdev discharge rates','x axis','y axis',1,'',...
...
hv_plot_xy_errors('last few voltage chunks in EDMRS','x axis','y axis',1,'',...
...
hv_plot_xy_errors('first few voltage chunks in EDMRS','x axis','y axis',1,'',...
...
hv_plot_xy_errors('leakage chunks in EDMRS','x axis','y axis',1,'',...
...
hv_plot_xy_errors('last few leakage chunks in EDMRS','x axis','y axis',1,'',...
...
hv_plot_xy_errors('first few leakage chunks in EDMRS','x axis','y axis',1,'',...
