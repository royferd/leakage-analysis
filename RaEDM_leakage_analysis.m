...
file_struct = dir('*20190104_ramptest_19kv.txt');
...
% %     ramp_up_avg_count_discharges,ramp_up_avg_dph,ramp_up_avg_dph_std,ramp_up_median_discharge_size,...
% %     overall_ramp_up_avg_dph,overall_ramp_up_avg_dph_std,overall_ramp_up_median_discharge_size] = ...
...
[ramp_up_avg_discharge_times,ramp_up_avg_discharge_times_cutoff,...
    ...
    lcm1_weight_avg_ramp_up_raw,time_ramp_up,lcm1_avg_ramp_up_avg_chunk,...
    lcm1_avg_ramp_up_stdev_chunk,num_up_chunks,...
    up_chunk_array,5.0,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('averages %.0f kV chunk ',...
    vmon_avg_ramp_up_avg),...
    'neg_voltage_avg_discharges',1,fullpath);
...
% %     ramp_up_avg_count_discharges_sum,ramp_up_avg_dph_sum,ramp_up_avg_dph_std_sum,ramp_up_median_discharge_size_sum,...
% %     overall_ramp_up_avg_dph_sum,overall_ramp_up_avg_dph_std_sum,overall_ramp_up_median_discharge_size_sum] = ...
% %     find_discharges_final(lcm1_avg_ramp_up_raw,...
...
[ramp_up_avg_discharge_times_sum,ramp_up_avg_discharge_times_sum_cutoff,...
    ...
    lcm1_weight_avg_ramp_up_raw,time_ramp_up,lcm1_avg_ramp_up_avg,...
    lcm1_avg_ramp_up_total_stdev,1,...
    one_big_up_chunk_array,5.0,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('averages %.0f kV chunk ',...
    vmon_avg_ramp_up_avg),...
    'neg_voltage_avg_discharges_summed',1,fullpath);
...
% %     ramp_down_avg_count_discharges,ramp_down_avg_dph,ramp_down_avg_dph_std,ramp_down_median_discharge_size,...
% %     overall_ramp_down_avg_dph,overall_ramp_down_avg_dph_std,overall_ramp_down_median_discharge_size] = ...
...
[ramp_down_avg_discharge_times,ramp_down_avg_discharge_times_cutoff,...
    ...
    lcm1_weight_avg_ramp_down_raw,time_ramp_down,lcm1_avg_ramp_down_avg_chunk,...
    lcm1_avg_ramp_down_stdev_chunk,num_down_chunks,...
    down_chunk_array,5.0,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('averages %.0f kV chunk ',...
    vmon_avg_ramp_down_avg),...
    'pos_voltage_avg_discharges',1,fullpath);
...
% %     ramp_down_median_discharge_size_sum,overall_ramp_down_avg_dph_sum,...
% %     overall_ramp_down_avg_dph_std_sum,overall_ramp_down_median_discharge_size_sum] = ...
% %     find_discharges_final(lcm1_avg_ramp_down_raw,...
...
[ramp_down_avg_discharge_times_sum,ramp_down_avg_discharge_times_sum_cutoff,...
    ...
    lcm1_weight_avg_ramp_down_raw,time_ramp_down,lcm1_avg_ramp_down_avg,...
    lcm1_avg_ramp_down_total_stdev,1,...
    one_big_down_chunk_array,5.0,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('averages %.0f kV chunk ',...
    vmon_avg_ramp_down_avg),...
    'pos_voltage_avg_discharges_summed',1,fullpath);
...
% %     zero_avg_count_discharges,zero_avg_dph,zero_avg_dph_std,zero_avg_median_discharge_size,...
% %     overall_zero_avg_dph,overall_zero_avg_dph_std,overall_zero_avg_median_discharge_size] = ...
...
[zero_avg_discharge_times,zero_avg_discharge_times_cutoff,...
    ...
    lcm1_weight_avg_zero_raw,zero_time,lcm1_avg_zero_avg_chunk,...
    lcm1_avg_zero_stdev_chunk,num_zero_chunks,...
    zero_chunk_array,5.0,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('averages %.0f kV chunk ',...
    vmon_avg_zero_avg),...
    'zero_voltage_avg_discharges',1,fullpath);
...
% %     zero_avg_median_discharge_size_sum,overall_zero_avg_dph_sum,overall_zero_avg_dph_std_sum,...
...
[zero_avg_discharge_times_sum,zero_avg_discharge_times_sum_cutoff,...
    ...
    lcm1_weight_avg_zero_raw,zero_time,lcm1_avg_zero_avg,...
    lcm1_avg_zero_total_stdev,1,...
    one_big_zero_chunk_array,5.0,3,lcm1_avg_scale,2,discharge_cutoff,sprintf('averages %.0f kV chunk ',...
    vmon_avg_zero_avg),...
    'zero_voltage_avg_discharges_summed',1,fullpath);
...
% %     zero_stdev_count_discharges,zero_stdev_dph,zero_stdev_dph_std,zero_stdev_median_discharge_size,...
% %     overall_zero_stdev_dph,overall_zero_stdev_dph_std,overall_zero_stdev_median_discharge_size] = ...
...
[zero_stdev_discharge_times,zero_stdev_discharge_times_cutoff, zero_stdev_discharge_vals, ...
    ...
    lcm1_weight_avg_zero_raw,zero_time,lcm1_zero_avg_stdev_of_chunk,...
    lcm1_avg_zero_stdev_stdev_chunk*ones(1,num_zero_chunks),num_zero_chunks,...
    zero_chunk_array,1.0,3,abs(lcm1_avg_scale),1,discharge_cutoff,sprintf('stdevs at %.0f kV chunk ',...
    vmon_avg_zero_avg),...
    'zero_voltage_stdev_discharges',1,fullpath);
...
% %     zero_stdev_median_discharge_size_sum,overall_zero_stdev_dph_sum,overall_zero_stdev_dph_std_sum,...
...
[zero_stdev_discharge_times_sum,zero_stdev_discharge_times_sum_cutoff,...
    ...
    lcm1_weight_avg_zero_raw,zero_time,lcm1_avg_zero_total_stdev,...
    lcm1_avg_zero_stdev_stdev_chunk,1,...
    one_big_zero_chunk_array,0.25,3,abs(lcm1_avg_scale),1,discharge_cutoff,sprintf('stdevs at %.0f kV chunk ',...
    vmon_avg_zero_avg),...
    'zero_voltage_stdev_discharges_summed',1,fullpath);
...
[zero_stdev_dph_sum_cutoff,zero_stdev_dph_std_sum_cutoff,...
    ...
    calc_discharge_rate(zero_stdev_discharge_times_sum_cutoff, zero_stdev_discharge_vals_sum_cutoff, ...
...
% %     ramp_down_stdev_median_discharge_size,overall_ramp_down_stdev_dph,overall_ramp_down_stdev_dph_std,...
...
[ramp_down_stdev_discharge_times,ramp_down_stdev_discharge_times_cutoff, ramp_down_stdev_discharge_vals, ...
    ...
    lcm1_weight_avg_ramp_down_raw,time_ramp_down,lcm1_ramp_down_avg_stdev_of_chunk,...
    lcm1_avg_ramp_down_stdev_stdev_chunk*ones(1,num_down_chunks),num_ramp_down_chunks,...
    down_chunk_array,1.0,3,abs(lcm1_avg_scale),1,discharge_cutoff,sprintf('stdevs at %.0f kV chunk ',...
    vmon_avg_ramp_down_avg),...
    'pos_voltage_stdev_discharges',1,fullpath);
...
% %     ramp_down_stdev_median_discharge_size_sum,overall_ramp_down_stdev_dph_sum,overall_ramp_down_stdev_dph_std_sum,...
...
[ramp_down_stdev_discharge_times_sum,ramp_down_stdev_discharge_times_sum_cutoff,...
    ...
    lcm1_weight_avg_ramp_down_raw,time_ramp_down,lcm1_avg_ramp_down_total_stdev,...
    lcm1_avg_ramp_down_stdev_stdev_chunk,1,...
    one_big_down_chunk_array,0.25,3,abs(lcm1_avg_scale),1,discharge_cutoff,sprintf('stdevs at %.0f kV chunk ',...
    vmon_avg_ramp_down_avg),...
    'pos_voltage_stdev_discharges_summed',1,fullpath);
...
% %     ramp_up_stdev_median_discharge_size,overall_ramp_up_stdev_dph,overall_ramp_up_stdev_dph_std,...
...
[ramp_up_stdev_discharge_times,ramp_up_stdev_discharge_times_cutoff, ramp_up_stdev_discharge_vals, ...
    ramp_up_stdev_discharge_vals_cutoff,ramp_up_stdev_discharge_stdevs,...
    ramp_up_stdev_discharge_stdevs_cutoff,...
    ramp_up_stdev_count_discharges,ramp_up_stdev_count_discharges_cutoff] = ...
    find_discharges_final(lcm1_avg_ramp_up_stdev_raw,...
    lcm1_weight_avg_ramp_up_raw,time_ramp_up,lcm1_ramp_up_avg_stdev_of_chunk,...
    lcm1_avg_ramp_up_stdev_stdev_chunk*ones(1,num_up_chunks),num_ramp_up_chunks,...
    up_chunk_array,1.0,3,abs(lcm1_avg_scale),1,discharge_cutoff,sprintf('stdevs at %.0f kV chunk ',...
    vmon_avg_ramp_up_avg),...
    'neg_voltage_stdev_discharges',1,fullpath);
...
% %     ramp_up_stdev_median_discharge_size_sum,overall_ramp_up_stdev_dph_sum,...
% %     overall_ramp_up_stdev_dph_std_sum,overall_ramp_up_stdev_median_discharge_size_sum] = ...
% %     find_discharges_final(lcm1_avg_ramp_up_stdev_raw,...
...
[ramp_up_stdev_discharge_times_sum,ramp_up_stdev_discharge_times_sum_cutoff,...
    ...
    lcm1_weight_avg_ramp_up_raw,time_ramp_up,lcm1_avg_ramp_up_total_stdev,...
    lcm1_avg_ramp_up_stdev_stdev_chunk,1,...
    one_big_up_chunk_array,0.25,3,abs(lcm1_avg_scale),1,discharge_cutoff,sprintf('stdevs at %.0f kV chunk ',...
    vmon_avg_ramp_up_avg),...
    'neg_voltage_stdev_discharges_summed',1,fullpath);
...
% all avg discharges
hv_plot_xy_errors('All avg. discharges',...
    sprintf('%d discharges at -20 kV \n %d discharges at +20 kV \n %d discharges at 0 kV',...
    sum(ramp_up_avg_count_discharges),sum(ramp_down_avg_count_discharges), ...
    sum(zero_avg_count_discharges)),...
    1,1,fullpath,'all-avg-discharges',...
    ramp_up_avg_discharge_times,zeros(1,length(ramp_up_avg_discharge_times)),...
...
% +/- V avg discharges
hv_plot_xy_errors('+V/-V avg. discharges',...
    sprintf('%d discharges at -20 kV \n %d discharges at +20 kV \n %d discharges at 0 kV',...
    sum(ramp_up_avg_count_discharges),sum(ramp_down_avg_count_discharges),...
    sum(zero_avg_count_discharges)),...
    1,1,fullpath,'pos-neg-avg-discharges',...
    ramp_up_avg_discharge_times,zeros(1,length(ramp_up_avg_discharge_times)),...
    ramp_up_avg_discharge_vals,ramp_up_avg_discharge_stdevs,ramp_down_avg_discharge_times,...
    zeros(1,length(ramp_down_avg_discharge_times)),...
...
hv_plot_xy_errors('All stdev discharges',...
    sprintf('%d discharges at -20 kV \n %d discharges at +20 kV \n %d discharges at 0 kV',...
    sum(ramp_up_stdev_count_discharges),sum(ramp_down_stdev_count_discharges),...
    sum(zero_stdev_count_discharges)),...
    1,1,fullpath,'all-stdev-dishcharges',...
    ramp_up_stdev_discharge_times,zeros(1,length(ramp_up_stdev_discharge_times)),...
...
% +/- V stdev discharges
hv_plot_xy_errors('+V/-V discharges',...
    sprintf('%d discharges at -20 kV \n %d discharges at +20 kV \n %d discharges at 0 kV',...
    sum(ramp_up_stdev_count_discharges),sum(ramp_down_stdev_count_discharges),...
    sum(zero_stdev_count_discharges)),...
    1,1,fullpath,'pos-neg-stdev-discharges',...
    ramp_up_stdev_discharge_times,zeros(1,length(ramp_up_stdev_discharge_times)),...
    ramp_up_stdev_discharge_vals,zeros(1,length(ramp_up_stdev_discharge_vals)),...
    ramp_down_stdev_discharge_times,...
    zeros(1,length(ramp_down_stdev_discharge_times)),...
...
hv_plot_xy_errors('+V/-V stdev discharges per hour','',...
    1,1,fullpath,'pos-neg-stdev-dph',...
...
hv_plot_xy_errors('All stdev median discharge size per hour with separate chunks','',...
    1,1,fullpath,'pos-neg-zero-stdev-median',...
    1:length(ramp_up_stdev_dph),zeros(1,length(ramp_up_stdev_dph)),...
...
hv_plot_xy_errors('All stdev median discharge size per hour with summed chunks','',...
    1,1,fullpath,'pos-neg-zero-stdev-median-sum',...
...
% hv_plot_xy_errors('',...
% 1,1,fullpath,'pos-neg-stdev-dph',...
% time_ramp_down(down_chunk_array(:,1,num_down_chunks):down_chunk_array(:,2,num_down_chunks)),...
% zeros(1,length(time_ramp_down(down_chunk_array(:,1,num_down_chunks):down_chunk_array(:,2,num_down_chunks)))),...
% vmon_avg_ramp_down_raw(down_chunk_array(:,1,num_down_chunks):down_chunk_array(:,2,num_down_chunks))*vmon_avg_scale,...
% vmon_avg_ramp_down_stdev(down_chunk_array(:,1,num_down_chunks):down_chunk_array(:,2,num_down_chunks))*vmon_avg_scale,...
% time_ramp_up(up_chunk_array(:,1,num_up_chunks):up_chunk_array(:,2,num_up_chunks)),...
% zeros(1,length(time_ramp_up(up_chunk_array(:,1,num_up_chunks):up_chunk_array(:,2,num_up_chunks)))),...
% vmon_avg_ramp_up_raw(up_chunk_array(:,1,num_up_chunks):up_chunk_array(:,2,num_up_chunks))*vmon_avg_scale,...
% vmon_avg_ramp_up_stdev_raw(up_chunk_array(:,1,num_up_chunks):up_chunk_array(:,2,num_up_chunks))*vmon_avg_scale,...
% time_trash(trash_chunk_array(:,1,113):trash_chunk_array(:,2,113)),...
% zeros(1,length(time_trash(trash_chunk_array(:,1,113):trash_chunk_array(:,2,113)))),...
% vmon_avg_trash_raw(trash_chunk_array(:,1,113):trash_chunk_array(:,2,113))*vmon_avg_scale,...
% vmon_avg_trash_stdev_raw(trash_chunk_array(:,1,113):trash_chunk_array(:,2,113))*vmon_avg_scale);

hv_plot_xy_errors('ramp simulation voltage data','',...
1,0,fullpath,'voltage-chunks-color-coded',...
...
hv_plot_xy_errors('ramp simulation leakage data','',...
1,0,fullpath,'leakage-chunks-color-coded',...
time_ramp_down(down_chunk_array(:,1,1)+1:down_chunk_array(:,2,num_down_chunks)),...
zeros(1,length(time_ramp_down(down_chunk_array(:,1,1)+1:down_chunk_array(:,2,num_down_chunks)))),...
lcm1_avg_ramp_down_raw(down_chunk_array(:,1,1)+1:down_chunk_array(:,2,num_down_chunks))*lcm1_avg_scale,...
lcm1_avg_ramp_down_stdev_raw(down_chunk_array(:,1,1)+1:down_chunk_array(:,2,num_down_chunks))*lcm1_avg_scale,...
time_ramp_up(up_chunk_array(:,1,1)+1:up_chunk_array(:,2,num_up_chunks)),...
zeros(1,length(time_ramp_up(1:up_chunk_array(:,2,num_up_chunks)))),...
lcm1_avg_ramp_up_raw(1:up_chunk_array(:,2,num_up_chunks))*lcm1_avg_scale,...
lcm1_avg_ramp_up_stdev_raw(1:up_chunk_array(:,2,num_up_chunks))*lcm1_avg_scale,...
time_trash(trash_chunk_array(1,1,1)+1:trash_chunk_array(:,2,num_trash_chunks)),...
zeros(1,length(time_trash(trash_chunk_array(1,1,1)+1:trash_chunk_array(1,2,num_trash_chunks)))),...
lcm1_avg_trash_raw(trash_chunk_array(1,1,1)+1:trash_chunk_array(1,2,num_trash_chunks))*lcm1_avg_scale,...
lcm1_avg_trash_stdev_raw(trash_chunk_array(1,1,1)+1:trash_chunk_array(1,2,num_trash_chunks))*lcm1_avg_scale);
...
fprintf(fileID,'total high voltage cycling time = %.2f hours \n',...
    (time_trash(trash_chunk_array(1,2,num_trash_chunks)) - ...
    time_ramp_down(down_chunk_array(1,1,1)+1))/60.0);
fprintf(fileID,'# ramp-up (%.1f kV) chunks = %d \n',vmon_avg_ramp_up_avg,num_up_chunks);
fprintf(fileID,'# ramp-down (%.1f kV) chunks = %d \n',vmon_avg_ramp_down_avg,num_down_chunks);
fprintf(fileID,'# zero (%.1f kV) chunks = %d \n\n',vmon_avg_zero_avg,num_zero_chunks);

fprintf(fileID,'********** Discharge rates for ramp-up (%.1f kV): ********** \n\n',vmon_avg_ramp_up_avg);
...
%ramp down data
fprintf(fileID,'\n');
fprintf(fileID,'********** Discharge rates for ramp-down (%.1f kV): **********\n\n',vmon_avg_ramp_down_avg);
...
%zero voltage data
fprintf(fileID,'\n');
fprintf(fileID,'********** Discharge rates for zero (%.1f kV): ********** \n\n',vmon_avg_zero_avg);
fprintf(fileID,'Steady state leakage current: %.1f pA \n\n',lcm1_avg_zero_avg);
