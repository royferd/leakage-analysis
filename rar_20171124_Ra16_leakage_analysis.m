...
% 11/26/2017 stdev for each measurement. I fucked up variable names so I have to use
...
vmon_avg_trash_raw_avg = zeros(num_files,1);
vmon_avg_trash_raw_avg_chunk = zeros(num_files,num_trash_chunk_rows,1);

vmon_avg_ramp_up_raw_stdev = zeros(num_files,1);

vmon_avg_ramp_down_raw_stdev = zeros(num_files,1);

vmon_avg_trash_raw_stdev = zeros(num_files,1);
...
lcm1_avg_trash_raw_avg = zeros(num_files,1);
lcm1_avg_trash_raw_avg_chunk = zeros(num_files,num_trash_chunk_rows,1);

lcm1_avg_ramp_up_raw_stdev = zeros(num_files,1);

lcm1_avg_ramp_down_raw_stdev = zeros(num_files,1);

lcm1_avg_trash_raw_stdev = zeros(num_files,1);
...
vmon_avg_trash_avg = zeros(num_files,1);
vmon_avg_trash_avg_chunk = zeros(num_files,num_trash_chunk_rows,1);
...
vmon_avg_trash_stdev = zeros(num_files,1);
vmon_avg_trash_stdev_chunk = zeros(num_files,num_trash_chunk_rows,1);
...
lcm1_avg_trash_avg = zeros(num_files,1);
lcm1_avg_trash_avg_chunk = zeros(num_files,1);
...
lcm1_avg_trash_stdev = zeros(num_files,1);
lcm1_avg_trash_stdev_chunk = zeros(num_files,1);
...
vmon_avg_trash_raw_avg_raw = zeros(num_files,1);
vmon_avg_trash_raw_avg_chunk_raw = zeros(num_files,num_trash_chunk_rows, 1);
...
vmon_avg_trash_raw_stdev_raw = zeros(num_files,1);
vmon_avg_trash_raw_stdev_raw_chunk = zeros(num_files,num_trash_chunk_rows,1);
...
lcm1_avg_trash_raw_avg_raw = zeros(num_files,1);
lcm1_avg_trash_raw_avg_chunk_raw = zeros(num_files,num_trash_chunk_rows,1);
...
lcm1_avg_trash_raw_stdev_raw = zeros(num_files,1);
lcm1_avg_trash_raw_stdev_raw_chunk = zeros(num_files,num_trash_chunk_rows,1);

lcm1_avg_ramp_down_raw_avg_wt = zeros(num_files,num_ramp_down_points);
vmon_avg_ramp_down_raw_avg_wt = zeros(num_files,num_ramp_down_points);

vmon_avg_ramp_up_raw_avg_wt = zeros(num_files,num_ramp_up_points);
lcm1_avg_ramp_up_raw_avg_wt = zeros(num_files,num_ramp_up_points);

vmon_avg_trash_raw_avg_wt = zeros(num_files,num_trash_points);
lcm1_avg_trash_raw_avg_wt = zeros(num_files,num_trash_points);
...
for i = 1:num_files
    ...
    vmon_avg_trash_raw_stdev(i) = std(vmon_avg_trash_raw(i,:),vmon_weight_avg_trash_raw(i,:));
    ...
    lcm1_avg_trash_raw_stdev(i) = std(lcm1_avg_trash_raw(i,:),lcm1_weight_avg_trash_raw(i,:));
    ...
    for j = 1:num_trash_points(i)        
        lcm1_avg_trash_raw_avg_wt(i,j) = lcm1_avg_trash_raw(i,j)*lcm1_weight_avg_trash_raw(i,j);
        vmon_avg_trash_raw_avg_wt(i,j) = vmon_avg_trash_raw(i,j)*vmon_weight_avg_trash_raw(i,j);               
    end
    ...
    lcm1_avg_trash_raw_avg(i) = sum(lcm1_avg_trash_raw_avg_wt(i,:)) / sum(lcm1_weight_avg_trash_raw(i,:));
    ...
    vmon_avg_trash_raw_avg(i) = sum(vmon_avg_trash_raw_avg_wt(i,:))/sum(vmon_weight_avg_trash_raw(i,:));
end
...
vmon_weight_trash_raw_stdev_raw_chunk = zeros(num_files,num_trash_chunk_rows);
lcm1_weight_trash_raw_stdev_raw_chunk = zeros(num_files,num_trash_chunk_rows);
vmon_avg_trash_raw_stdev_avg_raw_chunk_wt = zeros(num_files,num_trash_chunk_rows,1);
lcm1_avg_trash_raw_stdev_avg_raw_chunk_wt = zeros(num_files,num_trash_chunk_rows,1);
...
vmon_avg_trash_raw_stdev_stdev_raw_chunk = zeros(num_files,1);
vmon_avg_trash_stdev_stdev_chunk = zeros(num_files,1);
lcm1_avg_trash_raw_stdev_stdev_raw_chunk = zeros(num_files,1);
lcm1_avg_trash_stdev_stdev_chunk = zeros(num_files,1);
...
vmon_avg_trash_raw_stdev_avg_raw_chunk = zeros(num_files,1);
vmon_avg_trash_stdev_avg_chunk = zeros(num_files,1);
lcm1_avg_trash_raw_stdev_avg_raw_chunk = zeros(num_files,1);
lcm1_avg_trash_stdev_avg_chunk = zeros(num_files,1);
...
for i = 1:num_files
    ...
    for j = 1:num_trash_chunks(i)
        ...
        for k = chunk_begin:chunk_end
            vmon_avg_trash_raw_stdev_raw_chunk(i,j) =( std(vmon_avg_trash_raw(i,chunk_begin:chunk_end),...
                vmon_weight_avg_trash_raw(i,chunk_begin:chunk_end)));
            vmon_weight_trash_raw_stdev_raw_chunk(i,j) = (vmon_avg_trash_raw_stdev_raw_chunk(i,j))^(-2);
            lcm1_avg_trash_raw_stdev_raw_chunk(i,j) =( std(lcm1_avg_trash_raw(i,chunk_begin:chunk_end),...
                lcm1_weight_avg_trash_raw(i,chunk_begin:chunk_end)));
            lcm1_weight_trash_raw_stdev_raw_chunk(i,j) = (lcm1_avg_trash_raw_stdev_raw_chunk(i,j))^(-2);
        end
        vmon_avg_trash_raw_stdev_avg_raw_chunk_wt(i,j) = vmon_avg_trash_raw_stdev_raw_chunk(i,j)*vmon_weight_trash_raw_stdev_raw_chunk(i,j);
        lcm1_avg_trash_raw_stdev_avg_raw_chunk_wt(i,j) = lcm1_avg_trash_raw_stdev_raw_chunk(i,j)*lcm1_weight_trash_raw_stdev_raw_chunk(i,j);
    end

        vmon_avg_trash_raw_stdev_stdev_raw_chunk(i) =1/sqrt(sum(vmon_weight_trash_raw_stdev_raw_chunk(i,:)));
        vmon_avg_trash_raw_stdev_avg_raw_chunk(i) = sum(vmon_avg_trash_raw_stdev_avg_raw_chunk_wt(i,:))/sum(vmon_weight_trash_raw_stdev_raw_chunk(i,:));
        lcm1_avg_trash_raw_stdev_stdev_raw_chunk(i) =1/sqrt(sum(lcm1_weight_trash_raw_stdev_raw_chunk(i,:)));
        lcm1_avg_trash_raw_stdev_avg_raw_chunk(i) = sum(lcm1_avg_trash_raw_stdev_avg_raw_chunk_wt(i,:))/sum(lcm1_weight_trash_raw_stdev_raw_chunk(i,:));
...
%     end
    ...
    for j = 1:num_trash_chunks(i)
        chunk_begin = trash_chunk_array(i,2,j) +1;
        chunk_end = trash_chunk_array(i,2,j+1);
        vmon_avg_trash_raw_avg_chunk(i,j) =( sum(vmon_avg_trash_raw_avg_wt(i,...
            chunk_begin:chunk_end))/sum(vmon_weight_avg_trash_raw(i,chunk_begin:chunk_end)));
        lcm1_avg_trash_raw_avg_chunk(i,j) =( sum(lcm1_avg_trash_raw_avg_wt(i,...
            chunk_begin:chunk_end))/sum(lcm1_weight_avg_trash_raw(i,chunk_begin:chunk_end)));
    end
    ...
    vmon_avg_trash_avg(i) = vmon_avg_trash_raw_avg(i)*vmon_avg_scale;
    ...
    vmon_avg_trash_stdev(i) =  vmon_avg_trash_raw_stdev(i)*vmon_avg_scale;
    ...
    lcm1_avg_trash_avg(i) = lcm1_avg_trash_raw_avg(i)*lcm1_avg_scale;
    ...
    lcm1_avg_trash_stdev(i) = lcm1_avg_trash_raw_stdev(i)*abs(lcm1_avg_scale);
    ...
    vmon_avg_trash_stdev_stdev_chunk(i) = vmon_avg_trash_raw_stdev_stdev_raw_chunk(i)*abs(vmon_avg_scale);
    vmon_avg_trash_stdev_avg_chunk(i) = vmon_avg_trash_raw_stdev_avg_raw_chunk(i)*abs(vmon_avg_scale);
    lcm1_avg_trash_stdev_stdev_chunk(i) = lcm1_avg_trash_raw_stdev_stdev_raw_chunk(i)*abs(lcm1_avg_scale);
    lcm1_avg_trash_stdev_avg_chunk(i) = lcm1_avg_trash_raw_stdev_avg_raw_chunk(i)*abs(lcm1_avg_scale);
    ...
    for j = 1:num_trash_chunks(i)
       vmon_avg_trash_avg_chunk(i,j) = vmon_avg_trash_raw_avg_chunk(i,j)*vmon_avg_scale;
       vmon_avg_trash_stdev_chunk(i,j) = vmon_avg_trash_raw_stdev_raw_chunk(i,j)*vmon_avg_scale;
       lcm1_avg_trash_avg_chunk(i,j) = lcm1_avg_trash_raw_avg_chunk(i,j)*lcm1_avg_scale;
       lcm1_avg_trash_stdev_chunk(i,j) = lcm1_avg_trash_raw_stdev_raw_chunk(i,j)*abs(lcm1_avg_scale);
    end
...
%        lcm1_weight_avg_trash(i,j) = lcm1_weight_avg_trash_raw(i,j)*lcm1_avg_scale;
        lcm1_inv_weight_avg_trash(i,j) = (lcm1_weight_avg_trash_raw(i,j))^(-1/2)*abs(lcm1_avg_scale);
