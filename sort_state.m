...
function [lcm1_avg_trash_raw,lcm1_weight_avg_trash_raw,...
    ...
    % ramp segments.
    % 5/20/2021 For calculating averages and finding discharges, trimming
    % is taken care of in find_discharges_final. When plotting leakage
    % using the chunk_arrays, the charging data is highlighted. Don't worry
    % though, charging data is not included in the discharge / steady-state
    % analyis.
    extra = 0;
