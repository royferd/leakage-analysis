function [dph,dph_std,median_discharge_size,...
    ...
    discharge_stdevs,discharges_per_chunk)

start_time = discharge_times(1);

first_discharge_time = discharge_times(1);
...
hour_number = 1;
    ...
    elseif length(discharge_times) > 1
        ...
        overall_dph = length(discharge_times(start_time_index:end))*60.0/(discharge_times(end) - ...
            discharge_times(start_time_index));
        ...
        for i =1:length(discharge_times)
            ...
            time_since_last_hour = discharge_times(i) - first_discharge_time - 60.0*hour_number;
            
            time_since_last_hour = discharge_times(i) - first_discharge_time + ...
...
%                 time_delta > 8.0
        ...
        if time_since_last_hour < 0.0 && start_time_index ~= length(discharge_times) && ...
                time_delta > 8.0
...
%                 time_delta < 8.0
        ...
        elseif time_since_last_hour < 0.0 && start_time_index ~= length(discharge_times) && ...
                time_delta < 8.0
